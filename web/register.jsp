...
<header class="container">
    <div class="site-branding">
        ...
        <h2 class="site-description">快注册吧 !</h2>
    </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control input-lg" name="username"
                                                       id="username" placeholder="输入账号" required="required"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            密码：
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control input-lg" name="phone" id="phone"
                                                       placeholder="输入电话号码" required="required"/>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            QQ：
                                            <div class="form-group">
                                                <input type="text" class="form-control input-lg" name="qq" id="qq"
                                                       placeholder="输入QQ" required="required"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control input-lg" name="email" id="email"
                                                       placeholder="输入Email" required="required"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-skin btn-block">注册
                                            </button>
                                        </div>
                                    </div>
                                </form>

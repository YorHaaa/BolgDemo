        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    ...
                    {
                    %>
                    <a class="page-scroll"><%=session.getAttribute("username")%></a>
                    <%
                        }
                    %>
                </li>
...
<header class="container">
    <div class="site-branding">
        <h1 class="site-title">
            <a href="index.jsp">
                <span><font face="微软雅黑">登录</font></span>
            </a>
        </h1>
        <h2 class="site-description"><font face="微软雅黑">欢迎你，快登录吧 !</font></h2>
    </div>
                ...
                <article>
                    <div class="art-content">
                        <div class="row">
                            <div class="col-md-8">
                                <style>#col-md-8{
                                    margin-left: 302px;margin-right: 302px;margin-bottom: 175px;margin-outside: 175px;}</style>
                                <h3><font face="微软雅黑">登录</font></h3>
                                <form name="form1" method="post" action="../login">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <button type="submit" class="btn btn-skin btn-block" name="login" id="login"><font face="微软雅黑">登录</font>
                                            </button>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <button type="submit" class="btn btn-skin btn-block" onclick="location.href='register.jsp'" name="register" id="register">
                                            <font face="微软雅黑"><font face="微软雅黑">没有账号吗？快注册一个吧</font></font>
                                        </button>
                                    </div>
                                </div>
                            </div>

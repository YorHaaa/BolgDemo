<%@ page import="Dao.ArticleTypeDao.ArticletypeDao" %>
<%@ page import="Dao.ArticleTypeDao.ArticletypeDaoImpl" %>
<%@ page import="Dao.ArticleDao.ArticleDaoImpl" %>
<%@ page import="Entity.Article" %>
<%@ page import="Entity.Article_type" %>
...
<div class="am-g tpl-g">
    ...
    <%
        ...
        int articleTypeId = article.getArticle_type();
        String article_type = articletypeDao.getArticletype(articleTypeId);
        request.setAttribute("article", article);
        request.setAttribute("article_type",article_type);
    %>
    <div class="tpl-content-wrapper">
        <ol class="am-breadcrumb">
            <li><a href="javascript:void(0);" class="am-icon-home" style="color: #999999;">首页</a></li>
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-body am-fr">
                            <form id="mainForm" action="../updateArticle" method="post"
                                  class="am-form tpl-form-border-form">
                                <div class="am-form-group">
                                    <label for="title" class="am-u-sm-12 am-form-label am-text-left">标题 <span
                                            class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-12">
                                        <input type="text" class="tpl-form-input am-margin-top-xs" id="title"
                                               name="title" placeholder="请输入标题文字" value="${requestScope.article.title}">
                                ...
                                <div class="am-form-group">
                                    <label class="am-u-sm-12 am-form-label am-text-left">分类<span
                                            class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-12">
                                        <input type="text" class="tpl-form-input am-margin-top-xs" id="article_type"
                                               name="article_type" placeholder="请输入文章类别" value="${requestScope.article_type}">
                                ...
                                <div class="am-form-group">
                                    <div class="am-form-group">
                                        <label for="editor" class="am-u-sm-12 am-form-label  am-text-left">文章内容</label>
                                        <div class="am-u-sm-12 am-margin-top-xs">
                                            <textarea class="" name="content" id='editor' style="margin-top: 30px;"
                                                      rows="10">${requestScope.article.content}</textarea>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <div class="am-u-sm-12 am-u-sm-push-12">
                                            <button type="submit" id="submitContent"

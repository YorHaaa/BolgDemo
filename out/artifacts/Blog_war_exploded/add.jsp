                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-body am-fr">
                            <form id="mainForm"  action="../write" method="post" class="am-form tpl-form-border-form"  >
                                <div class="am-form-group">
                                    <label for="title" class="am-u-sm-12 am-form-label am-text-left">标题 <span class="tpl-form-line-small-title"></span></label>
                                    <div class="am-u-sm-12">
                                        <input type="text" class="tpl-form-input am-margin-top-xs" id="title" name="title" placeholder="请输入标题文字" value="">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-12">
                                        <input type="text" class="tpl-form-input am-margin-top-xs" id="article_type" name="article_type" placeholder="请输入文章类别" value="">
                                ...
                                <div class="am-form-group">
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-12 am-margin-top-xs">
                                            <textarea class="" name="content"  id='editor' style="margin-top: 30px;" rows="10"></textarea>
                                        </div>
                                    </div>

                                    <div class="am-form-group">
                                        <div class="am-u-sm-12 am-u-sm-push-12">
                                            <button type="submit" id="submitContent"  class="am-btn am-btn-primary tpl-btn-bg-color-success ">提交</button>
                                        </div>
                                    </div>
                                </div>
                            </form>

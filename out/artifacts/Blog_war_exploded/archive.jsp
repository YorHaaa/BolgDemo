			...
			<div class="container">
				<div class="row">
					<%
						...
						List<Article> article = articleDao.findByUserId(id);
						request.setAttribute("Art",article);
					%>
					<c:forEach items="${requestScope.Art}" var="article">
						<div class="col-md-4">
							<div class="box-item">
								<div class="content">
									<h3>${article.title}</h3>
									<a href="single.jsp?id=${article.id}"><font face="微软雅黑">更多</font></a><br>
									<a href="updateArticle.jsp?ArticleId=${article.id}"><font face="微软雅黑">修改文章</font></a><br>
									<a href="delete?id=${article.id}"><font face="微软雅黑">删除文章</font></a><br>
									<br><br>
